...
//  gameoverF = SD.open("gameover.txt");
//  if (gameoverF) {
//    Serial.println("gameover.txt:");
//
//    // read from the file until there's nothing else in it:
//    while (gameoverF.available()) {
//      Serial.write(gameoverF.read());
//    }
//    // close the file:
//    gameoverF.close();
//  } else {
//    // if the file didn't open, print an error:
//    Serial.println("Ha ocurrido un error abriendo gameover.txt");
//  }
...
//----------------------------------------------------------
  ...
  //unsigned char gameover1 [] = gameover;
